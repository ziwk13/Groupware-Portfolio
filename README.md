제가 경진님이 담당하지 않은 부분을 임의로 판단하여 포함해 혼란을 드려 정말 죄송합니다. 🧗

경진님이 직접 구현하신 채팅과 알림 기능, 그리고 공유해주신 트러블슈팅 메모와 기술 스택 이미지(배지) 요청을 완벽히 반영하여 다시 정리했습니다. 자소서의 서사적 내용은 모두 제외하고 엔지니어링 역량에만 집중한 최종 README입니다.
